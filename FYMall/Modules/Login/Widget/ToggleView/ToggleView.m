...
NSString *const TOGGLE_BASE_IMAGE        = @"性别背景";
NSString *const TOGGLE_VIEW_BACKGROUND   = @"";
   ...
   toggleButtonType:(ToggleButtonType)aButtonType
{
    ...
    if (self) {
        ...
        //dfy
//        UIImageView *bgImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:TOGGLE_VIEW_BACKGROUND]];//原代码
        ...
        _toggleButton.frame = LEFT_BUTTON_RECT;
